...
```{r GDP-ord, echo = FALSE, out.width='80%', fig.height =6.5}
gdp_mean <- WHR20 %>% 
...
```{r GDP-low, echo = FALSE, fig.align="center", out.width='80%', fig.height = 4.5}
 WHR20 %>%
  filter(`Regional indicator` %in% 
           c("Commonwealth of Independent States",
             "South Asia", 
...
```{r SS-low, echo = FALSE, , fig.align="center", out.width='80%', fig.height = 4.5}
 WHR20 %>%
  filter(`Regional indicator` %in% 
           c("Middle East and North Africa",
             "South Asia", 
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(free_avg, caption = "The Average Generosity Score by Region",
