...
\section*{1 Happiness Score by Region}
...
\clearpage
\section*{3 Happiness score in differetent countries }
...
\subsection*{3.1 Compare Top5, Middle5 and Worst5 Countries }
...
* In the above figure \@ref(fig:compare), we have taken the top 5, middle 5 and the bottom 5 countries to understand the relations between 6 factors and happiness score. 
...
\subsection*{3.2 Happiness Score for Countries }
